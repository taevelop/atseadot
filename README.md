...
체력은 하트 5칸으로 시작합니다. 상어 충돌은 반 칸, 메갈로돈 충돌은 한 칸을 소모하며 피격 후 약 1초간 추가 피해를 받지 않습니다. 상자는 한 번만 하트 한 칸을 회복하고 기존처럼 특별 미끼를 해금합니다. 체력이 없으면 게임오버 화면에서 Z/Enter·다시 잠수로 재시작하거나 X/Esc·시작 화면으로 돌아갑니다.
